...
// the paths components are assigned intide the:
// /src/routes/sections/
...
export const paths = {
  ...
  dashboard: {
    ...
    user: {
      ...
      address: {
        list: (user_id) => `${ROOTS.DASHBOARD}/user/${user_id}/account/address`,
        create: (user_id) => `${ROOTS.DASHBOARD}/user/${user_id}/account/address/new`,
        edit: (user_id, address_id) =>
          `${ROOTS.DASHBOARD}/user/${user_id}/account/address/edit/${address_id}`,
      },
    ...
    brand: {
      ...
      details: (id) => `${ROOTS.DASHBOARD}/brand/${id}`,
      edit: (id) => `${ROOTS.DASHBOARD}/brand/${id}/edit`,
      demo: {
        details: `${ROOTS.DASHBOARD}/brand/${MOCK_ID}`,
        edit: `${ROOTS.DASHBOARD}/brand/${MOCK_ID}/edit`,
      },
    },
    invoice: {
